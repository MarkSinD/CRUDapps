...
public class ProviderService {
    ...
    public boolean isNameUnique(Integer id, String name){
        Provider providerByEmail = providerRepository.getProviderByEmail(id);

        if( id != null && providerByEmail == null) {
            return true;
        }
        else if( id != null && providerByEmail != null) {
            if(!providerByEmail.getId().equals(id))
                return false;
            else
                return true;
        }
